...
class WPAchievements_Admin_Widget_Latest_Quests {

  public static function output() {

    $activities = WPAchievements_Admin_Stats::get_latest_activities( 'achievement' );
    ?>
    <table width="100%" class="widefat wpachievements-table-stats" id="wpachievements-latest-plays">
      <thead>
        <tr>
          ...
          <th class="th-center">
            <?php _e( 'Achievement', 'wpachievements' ); ?>
          </th>
          <th class="th-center">
...
WPAchievements_Admin_Widget_Latest_Quests::output();